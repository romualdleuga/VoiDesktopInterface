...
public class VehicleOfInterestController {
    ...
    */  
    {
        ...
        String[][] allReasonOfInteresttArr = new String[reasonOfInterestList.size()][5];
    ...
    */  
    ...
    public String[] getDescriptionByReason(String reason){
        ...
        try
        {
           ...
           PreparedStatement pstmt = conn.prepareStatement("Select description from reason_for_interest where reason = ?");      
          ...
          // create database statement from connection
           ...
           {
               // load data into product object from result set
               reasonsForInterestList.add(rs.getString("description"));
           }
    ...
    public void createVehicleOfInterest(String licensePlate, String reason, String make,
            String model, String veh_year, String color, String ownersName, String ownersPhone) throws Exception
     /*
    ...
    public String[] getModelByMake(String make){
        ...
        try
        {
           ...
           // all fields for vehicle of interest record
           PreparedStatement pstmt = conn.prepareStatement("select Model from VEHICLE_MODEL where Make=?");      
           pstmt.setString(1, make);
          ...
          // create database statement from connection
           ...
           {
               // load data into product object from result set
               reasonsForInterestList.add(rs.getString("model"));
           }
    ...
    public String[][] getVehicleOfInterestByLicensePlate(String licensePlate)
    /*
            Description:  This method returns all of the vehicle of interest
            as a 2D array.  It is in the form of [row][column].  The first 
            column is the license plate, second reason, followed by make, model
